...
namespace GymManager.DataAccess.Migrations
{
    ...
    [Migration("20220202233258_02-02-2022_03")]
    partial class _02022022_03
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManager.Core.Assists.Assistance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int?>("AssitanceTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssitanceTypeId");

                    b.ToTable("Assists");
                });

            modelBuilder.Entity("GymManager.Core.Assists.AssitanceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManager.Core.Assists.Assistance", b =>
                {
                    b.HasOne("GymManager.Core.Assists.AssitanceType", "AssitanceType")
                        .WithMany("Assists")
                        .HasForeignKey("AssitanceTypeId");

                    b.Navigation("AssitanceType");
                });

            modelBuilder.Entity("GymManager.Core.Members.Member", b =>
                {
                    b.HasOne("GymManager.Core.Assists.Assistance", null)
                        .WithMany("Members")
