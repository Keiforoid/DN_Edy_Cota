...
namespace DataAccess.Example
{
    class Program
    {
        const string mysqlConnectionString = "server=localhost;port=3306;database=sqltesting;user=root;CharSet=utf8;SslMode=none;Pooling=false;AllowPublicKeyRetrieval=True;password=1234";
        ...
        static void Main(string[] args)
        {
            ...
            var firstUser = GetUsersById(3);
            var secondUser = GetUsersById(4);
        ...
        private static User GetUsersById(int userId)
        {
            User user = new User();
