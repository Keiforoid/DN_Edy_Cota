...
namespace GymManager.Web.Controllers
{
    public class MembershipController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Renewal(MemberListViewModel viewModel)
        {
            MemberListViewModel _viewModel = viewModel;

            List<Member> members = await _membersAppService.GetMembersAsync(_viewModel.SearchString);
