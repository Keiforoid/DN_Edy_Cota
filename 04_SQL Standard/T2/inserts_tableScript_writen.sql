...
insert into company (idcompany,companyname,location) values (3,'Tesla Test','AM');
...
insert into city (idcity,name,idcountry) values (8,'Las habana',5);

insert into city (idcity,name,idcountry) values (9,'Medeyin',5);
insert into city (idcity,name,idcountry) values (10,'Barranquiya',5);

# No me dejo insertar las ciudades con idcountry 6 por que no existia
insert into city (idcity,name,idcountry) values (11,'Monterrey',4);
